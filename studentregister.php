            ...
            ?>                
              ...
              <div class="col-12 col-md-3">
                <div class="form-group ">                             
                  ...
                  <select type="text"  class="form-control" id="subcourse" name="subcourse" placeholder="Sub Course"  onchange="getDurationFees()">
              ...
              <div class="col-12 col-md-3">
                <div class="form-group ">                             
                  ...
                  <select class="form-control" id="duration" name="duration" placeholder="Time duration">
              ...
              <div class="col-12 col-md-3">
                <div class="form-group">
                  <label for="exampleInput">Fees structure</label>
                    <select class="form-control" id="fees" name="fees" placeholder="Fees structure">
   ...
   if(isset($_POST['insert']))
     { 
      ...
      $endingtime = mysqli_real_escape_string($db,trim($_POST['endingtime']));
              ...
              $sql = "INSERT INTO  `student_register` (name,fathername,mothername,address,mobile,mobile1,dob,adharno,studentid,stu_image,qualification,coursename,subcourse,duration,fees,book,endingtime,entrytime,updatetime)
              VALUES ('$name','$fathername','$mothername','$address','$mobile','$mobile1','$dob','$adharno','$studentid','$filename','$qualification','$coursename','$subcourse','$duration','$fees','$book','$endingtime','$date','$date')";
